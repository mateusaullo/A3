...
public class SimpleLangLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"IF", "ELSE", "WHILE", "FOR", "DO", "PRINTF", "SCANF", "INT_TYPE", "FLOAT_TYPE", 
			"STRING_TYPE", "PLUS", "MINUS", "MULT", "DIV", "MOD", "EQ", "NEQ", "LT", 
			"GT", "LTE", "GTE", "AND", "OR", "NOT", "ASSIGN", "LPAREN", "RPAREN", 
			"LBRACE", "RBRACE", "SEMICOLON", "COMMA", "NUMBER", "STRING_LITERAL", 
			"ID", "LINE_COMMENT", "BLOCK_COMMENT", "WS", "DIGIT"
		};
	}
